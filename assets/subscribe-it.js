...
.appikon-bis-form-warning{
  ...
  ;(!(function (t, e) {
    ...
    function l(e, n) {
      ...
      function o(t) {
        if (('string' == typeof t && (t = t.split(b, 2)), !m(t) || 2 !== t.length))
    ...
    function () {
      ...
      this.SI = {
        ...
        findElmByClassName: function (t, e) {
          var n, i, r, o, s
          for (s = [], i = 0, r = (o = e.getElementsByTagName('*')).length; i < r; i++)
        ...
        extend: function () {
          ...
          for (
            o = arguments[0],
              n = 0,
              r = (a = 2 <= arguments.length ? t.call(arguments, 1) : []).length;
            n < r;
            n++
          ) {
            s = a[n]
        ...
        urlIsProductPage: function () {
          return (
            null != decodeURIComponent(window.location.pathname).match(this.PRODUCT_HANDLE_REGEX)
          )
        },
        toQueryString: function (t, e) {
          ...
          for (n in t)
            ((o = t[n]),
              e && (n = e + '[' + n + ']'),
              (r =
                'object' == typeof o ? this.toQueryString(o, n) : n + '=' + encodeURIComponent(o)),
              i.push(r))
          return i.join('&')
        },
        urlParamsToObject: function () {
          var t, e, n, i, r
          for (r = {}, n = 0, i = (e = location.search.substr(1).split('&')).length; n < i; n++)
            r[(t = e[n].split('='))[0]] = t[1]
          return r
        },
        urlParam: function (t) {
        ...
        jsonFromParams: function (t) {
          var e, n, i, r, o
          for (o = {}, n = 0, r = (e = t.split('&')).length; n < r; n++)
            o[(i = e[n].split('='))[0]] = i[1]
        ...
        helpers: {
          smallProductImage: function () {
            return function (t, e) {
              var n
              return e(
                (n = t.split('.')).slice(0, n.length - 1).join('.') + '_small.' + n.slice(-1)
              )
            }
          },
        },
        createPopover: function (t) {
          ...
          return (
            ...
            (e = SI.extend(
              SI.Config,
              'undefined' != typeof _SIConfig && null !== _SIConfig ? _SIConfig : {},
              t
            )),
            new SI.Popover(e)
          )
        ...
        genericTriggerHandler: function (t) {
          var e, n, i, r, o, s
          if (
            null != (o = ((t = t || window.event).target || t.srcElement).className) &&
            'function' == typeof o.match
              ? o.match(/SI_trigger/)
              : void 0
          ) {
            if (
        ...
        init: function () {
          ...
          if (
            ...
            !0 === SI.Config.generic_trigger_handler &&
              SI.on(document, 'click', SI.genericTriggerHandler),
        ...
        return (
          ...
          (e.prototype.variantSoldOut = function (t) {
            1 !== this.settings.instock_qty_level &&
              ...
              SI.log(
                'Warning: Show for preorder is off: ignoring custom instock_qty_level setting.'
              )
            if (null != t.inventory_quantity) {
              ...
              !1 === this.settings.instock_qty_level &&
                SI.log('Warning: instock_qty_level is set but inventory_quantity not available.')
              return !1 === t.available
            }
          }),
          (e.prototype.variantMeetsInventoryManagementPolicy = function (t) {
            return (
              !this.settings.require_inventory_management ||
              (t.inventory_management && t.inventory_management.length > 0)
            )
          }),
            ...
            for (
              r = {},
                o = function (t) {
                  var e
                  return (
                    !((null != (e = s.sku) ? e.length : void 0) > 0) ||
                    (null == r[t] && (r[t] = 1) && !0)
                  )
                },
                i = [],
          ...
          (e.prototype.getProducts = function () {
            ...
            return (
              ...
              (n = this),
              (t = function () {
                if ((n.processProductVariants(n.product), n.variants.length > 0))
              ...
              this.product
                ...
                : (e = this._productDataURL()) &&
                  SI.request(e).then(
                    ...
                    function (e, n) {
                      return e
                        ? SI.log('SI.Base: error loading product data (' + n + ')')
                        : ((i.product = SI.parseJSON(n)), t())
                    })
                  ),
              this.ready
            )
          ...
          (e.prototype.create = function (email, e, productId, stockNotificationRequestDetails) {
            ...
            if (stockNotificationRequestDetails.pushSubscriptionToken) {
              requestObj.pushSubscriptionToken =
                stockNotificationRequestDetails.pushSubscriptionToken
            }
            ...
            null != stockNotificationRequestDetails.recaptcha_response &&
              (finalRequestObj.recaptcha_response =
                stockNotificationRequestDetails.recaptcha_response)
          ...
          (e.prototype._parseProductHandleFromURL = function () {
            var t
            return (
              (t = decodeURIComponent(window.location.pathname).match(SI.PRODUCT_HANDLE_REGEX)) &&
              t[1]
            )
          }),
          e
      ...
      SI.detectVariant = function (popup) {
        ...
        if (i) {
          ...
          r = (function () {
            ...
            if (
              singleOptionSelector != null &&
              singleOptionSelector.selectedIndex != null &&
              singleOptionSelector.selectedIndex !== -1
            ) {
          ...
          if (n) {
            ...
            if (false === popup.product.available) {
              ...
              if (variant && variant.inventory_quantity != null) {
                if (
                  variant.inventory_quantity < popup.settings.instock_qty_level &&
                  popup.settings.preorder_enabled
                ) {
                  return variant
                } else {
                  return void 0
        ...
        return (
          (e.prototype.render = function () {
            ...
            return (
              ...
              (this.settings.container || document.getElementsByTagName('body')[0]).appendChild(
                this.wrap
              ),
          ...
          (e.prototype.buildButton = function (t) {
            ...
            return (
              ...
              'textContent' in n
                ? (n.textContent = this.settings.caption)
                : (n.innerText = this.settings.caption),
              (e = {
      ...
      SI.Form = (function () {
        function n(e, n) {
          ...
          ;(SI.defer(
            ...
            (this.popover.settings.root || document.getElementsByTagName('body')[0]).appendChild(
              this.frame
            ))
        }
        ...
        return (
          ...
          (r =
            (i = 'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input') +
            '/17.0.5/js/intlTelInput.min.js'),
          ...
          (n.prototype.mobileDevice = function () {
            return (
              ...
              ('function' == typeof window.getComputedStyle
                ? window.getComputedStyle(this.frame).getPropertyValue('position')
                : void 0)
            )
          }),
          ...
          (n.prototype.injectCSS = function (t) {
            return (
              ...
              this.styleElm.styleSheet
                ? (this.styleElm.styleSheet.cssText = t)
                : this.styleElm.appendChild(document.createTextNode(t)),
              this.styleElm
            )
          }),
          (n.prototype.selectVariant = function (t) {
            ...
            if (null != t)
              for (
                t = parseInt(t, 10),
                  e = n = 0,
                  i = (o = (s = SI.$('#variants', this.frameDoc())).options).length;
                n < i;
                e = ++n
              )
          ...
          (n.prototype.show = function (t) {
            ...
            return (
              ...
              !0 === this.mobileDevice() &&
                (this.frame.style.height = this.frame.parentElement.scrollHeight + 'px'),
              (this.isOpen = !0),
              this
            )
          }),
          ...
          (n.prototype.render = function (t, e) {
            ...
            templateVars = SI.extend({}, e, SI.helpers, {
              ...
              is_default_variant:
                ...
                ('Default' === (l = this.popover.variants[0].title) ||
                  'Default Title' === l ||
                  'DEFAULT TITLE' === l),
              ...
              newsletter_permission_default_checked:
                this.popover.settings.newsletter_permission_default_checked,
          ...
          (n.prototype.submit = function (t) {
            ...
            if (!this.popover.settings.recaptcha_enabled || (null != a ? a.value : void 0)) {
              ...
              if (
                !emailFinal &&
                !stockNotificationRequestDetails.phone_number &&
                !stockNotificationRequestDetails.pushSubscriptionToken
              ) {
          ...
          (n.prototype.toggleComplete = function (t) {
            ...
            return (
              ...
              t
                ...
                : (e.className = e.className.replace(/complete/g, '')),
              this
            )
          }),
          ...
          (n.prototype.submitButton = function () {
            return (
              this._submitButton || (this._submitButton = SI.$('[type=submit]', this.frameDoc()))
            )
          }),
          n
        )
      ...
      SI.MobiliaForm = (function (e) {
        function n(t, e) {
          ...
          ;((this.formEl = t),
            ...
            (i = {
              accepts_marketing:
                null != this.acceptsMarketingState() ? this.acceptsMarketingState() : null,
        ...
        return (
          ...
          (i.prototype.triggerHandler = function (t) {
            ...
            for (e = t.target || t.srcElement, n = []; e; ) {
              if (
                null != e.getAttribute &&
                (e.getAttribute('id') === this.settings.trigger ||
                  e.getAttribute('className') === this.settings.trigger)
              ) {
                ;(SI.preventDefault(t),
          ...
          (i.prototype.createUI = function () {
            if (
              ((this.form = new SI.Form(this, this.settings.mobile_css)),
              ...
              return (
                ...
                this.button.ready.then(
                  ((t = this),
                  function () {
                    return null != t.settings.multivariantDropdownContainer
                      ? t.variantChanged()
                      : t.button.toggle(t.variants.length > 0)
                  })
                )
              )
            var t
          ...
          (i.prototype.alert = function (t) {
            return (
              console && console.log && console.log('SI.Popover.alert() is deprecated.'),
              alert(t)
            )
          }),
          ...
          (i.prototype.toggleForVariant = function (t) {
            var e
            if (
              null != (e = this._variantsById[t] || this._variantsByTitle[t]) &&
              null != this.button
            )
              return (
                this.button.elm.setAttribute('data-variant-id', e.id),
        ...
        t.prototype.trackCheckout = function () {
          ...
          if (null != (t = this.getCookie(this.key))) {
            ...
            return this.track('checkout', {
              checkout_token:
                'undefined' != typeof Shopify && null !== Shopify && null != (e = Shopify.checkout)
                  ? e.token
                  : void 0,
              si_id: t,
              order_id:
                'undefined' != typeof Shopify && null !== Shopify && null != (n = Shopify.checkout)
                  ? n.order_id
                  : void 0,
              subtotal_price:
                'undefined' != typeof Shopify && null !== Shopify && null != (i = Shopify.checkout)
                  ? i.subtotal_price
                  : void 0,
              total_price:
                'undefined' != typeof Shopify && null !== Shopify && null != (r = Shopify.checkout)
                  ? r.total_price
                  : void 0,
              checkout_step:
                'undefined' != typeof Shopify && null !== Shopify && null != (o = Shopify.Checkout)
                  ? o.step
                  : void 0,
              order_created_at:
                'undefined' != typeof Shopify && null !== Shopify && null != (s = Shopify.checkout)
                  ? s.created_at
                  : void 0,
  ...
  SI.Config = {
    ...
    labels: {
      ...
      fb_instruction_message:
        ' Clique abaixo para receber notifica\u00E7\u00E3o no Facebook Messenger',
    ...
    button: {
      ...
      border_radius: 3,
      image:
        '//static.back-in-stock.appikon.com/assets/widget/notify-btn-vertical-f46bd7ac1b51e7d3c6a766d843fe60b46f8628e13e717124d83ffe65be466f4d.png',
      visible: false,
  ...
  SI.Config.shop = 'bioself-natura.myshopify.com'
  ...
  if (
    SI.Config.button.selected_selector !== '' &&
    !document.querySelector(SI.Config.button.selected_selector)
  ) {
  ...
  var bisProductPageFunction = function () {
    ...
    if (
      SI.urlIsProductPage() == false &&
      SI.Config.show_notify_me_button_on_collection_page == false
    ) {
...
`
    ...
    if (typeof intlTelInput == 'undefined') {
      ...
      intlTelInputCSS.href =
        'https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.5/css/intlTelInput.css'
    ...
    if (SI.Config.isInlineFormEnabled) {
      appikonBisInlineForm = jQuery(
        Mustache.render(appikonBisInlineFormTemplate.trim(), appikonBisInlineFormTemplateVars)
      )

      if (!appikonBisInlineFormTemplateVars.only_sms_enabled) {
        appikonBisInlineForm.find('#appikon-bis-inline-form-email').on('change', function (t) {
          var appikonBisInlineFormEmail = appikonBisInlineForm
            .find('#appikon-bis-inline-form-email')
            .val()
          const emailPattern =
            /^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/
          if (!emailPattern.test(appikonBisInlineFormEmail)) {
            jQuery('#appikon-bis-form-email-warning')
              .removeClass('appikon-bis-form-hide-warning')
              .addClass('appikon-bis-form-warning')
            jQuery('#appikon-bis-inline-form-submit').attr('disabled', 'true')
          } else {
            jQuery('#appikon-bis-form-email-warning')
              .removeClass('appikon-bis-form-warning')
              .addClass('appikon-bis-form-hide-warning')
        ...
        appikonBisInlineForm.find('#appikon-bis-inline-form-submit').on('click', function (t) {
          ...
          var appikonBisacceptMarketing = appikonBisInlineForm
            .find('[name="customer_accepts_marketing"]')
            .is(':checked')
          var appikonBisInlineFormMessage = appikonBisInlineForm.find(
            '#appikon-bis-inline-form-message'
          )
          if (!appikonBisInlineFormEmail && !appikonBisInlineFormPhoneNumber) {
            ...
            if (appikonBisInlineFormTemplateVars.show_terms_and_conditions == true) {
              var BisInlineFormMessage = appikonBisInlineForm.find(
                '#appikon-bis-inline-form-message'
              )
              var tcAccepted
              if (jQuery('#acceptTermsAndConditionsForInlineForm').is(':checked')) {
            ...
            SI.create(
              appikonBisInlineFormEmail,
              appikonBisInlineFormVariantId,
              SI.popup.product.id,
              {
                phone_number: appikonBisInlineFormPhoneNumber,
                accepts_marketing: appikonBisacceptMarketing,
              }
        ...
        appikonBisInlineForm.find('#appikon-bis-inline-form-submit').on('click', function (t) {
          ...
          if (!appikonBisInlineFormPhoneNumber) {
            ...
            appikonBisInlineFormMessage.html('')
            jQuery(t.target).prop('disabled', true)
            SI.create(null, appikonBisInlineFormVariantId, SI.popup.product.id, {
              phone_number: appikonBisInlineFormPhoneNumber,
              accepts_marketing: appikonBisacceptMarketing,
            }).then(function (st, resp) {
              resp = SI.parseJSON(resp)
    ...
    100% {
      opacity: 1
          ...
          function logic() {
            ...
            jQuery('body')
              .append(`<div id="KILATECH_CountdownTimer_MAIN" style="display: none !important;">
</div>`)
          }
          ...
          function loadAppkionTimer() {
            ...
            function playanimation(old_value, new_value, type) {
              ...
              isRightFlip =
                jQuery(right + ' .card-text-KT').text() !=
                jQuery(right + ' .card-back-text-KT').text()
              isLeftFlip =
                jQuery(left + ' .card-text-KT').text() !=
                jQuery(left + ' .card-back-text-KT').text()
              if (isRightFlip) {
            ...
            function start_Countdown_KT() {
              ...
              var selectedVariant = products.find(
                (p) =>
                  p.variantId == variant_id ||
                  (p.variantId == 0 && p.productId == SI.popup.product.id)
              )

              KT_TOTAL = selectedVariant
                ? Math.round((selectedVariant.expirationTime - Date.now()) / 1000)
                : -1

              if (
                SI.Config.button.countdown_timer_expiration &&
                SI.Config.button.countdown_timer_reset_enabled
              ) {
                var n = 2
                while (KT_TOTAL <= 0) {
                  KT_TOTAL = Math.round(
                    (SI.Config.button.countdown_timer_expiration + n * 86400 - Date.now()) / 1000
                  )
                  n = n * 2
                }
              }
        ...
        var placement = 'AFTER'
        if (
          jQuery('#SI_trigger').length == 0 &&
          jQuery('#appikon-bis-inline-form-wrapper').length == 0
        ) {
          if (placement === 'BEFORE') {
  ...
  function setBisProductPageButtonStyles() {
    ...
    if (mainButtonSettings.main_css_classes) {
      ...
      mainButton.attr(
        'class',
        mainButtonSettings.main_css_classes.trim() + ' ' + originalMainCssClasses
      )
    }
    ...
    if (mainButtonSettings.main_hover_text_color) {
      ...
      mainButton.hover(
        ...
        function () {
          jQuery(this).css(
            'color',
            originalMainButtonHoverTextColor ? originalMainButtonHoverTextColor : ''
          )
        }
      )
    }
    ...
    if (mainButtonSettings.main_hover_background_color) {
      ...
      mainButton.hover(
        ...
        function () {
          jQuery(this).css(
            'background-color',
            originalMainHoverBgColor ? originalMainHoverBgColor : ''
          )
        }
      )
    }
    ...
    if (mainButtonSettings.main_hover_border_color) {
      ...
      mainButton.hover(
        ...
        function () {
          jQuery(this).css(
            'border-color',
            originalMainHoverBorderColor ? originalMainHoverBorderColor : ''
          )
        }
      )
    }
